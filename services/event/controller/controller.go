...
func SetupController(route *mux.Route) {
	...
	metrics.RegisterHandler("/getAllEventsAttendance", GetAllEventsAndAttendees, "GET", router)

}

/*
Endpoint to get the list of events and their attendees
*/
func GetAllEventsAndAttendees(w http.ResponseWriter, r *http.Request) {
	eventList, err := service.GetAllEventsAndAttendees()
	if err != nil {
		errors.WriteError(w, r, errors.DatabaseError(err.Error(), "Could not get all events and attendees."))
		return
	}
